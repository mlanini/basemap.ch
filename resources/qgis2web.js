...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 19, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2056',
            extent: [2672472.000000, 1075256.125000, 2732925.000000, 1165712.250000],
            units: 'm'})
    })
});
...
map.getView().fit([2702489.347757, 1112747.448242, 2706542.764428, 1114895.864911], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = 'Map project: <a href="https://www.intelligeo.ch/">intelligeo.ch</a> &middot; <a href="mailto:ask@intelligeo.ch/">Contact</a> &middot; Data sources: &copy; <a href="https://www.geo.ti.ch/">Repubblica e Cantone Ticino</a> &middot; &copy; <a href="https://www.swisstopo.ch/">swisstopo</a> &middot; Powered by: <a href="https://github.com/tomchadwin/qgis2web">qgis2web</a> &middot; ';
